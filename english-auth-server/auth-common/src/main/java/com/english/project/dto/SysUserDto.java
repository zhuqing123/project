package com.english.project.dto;
...
public class SysUserDto implements Serializable {
    ...
    @ApiModelProperty(value = "登录名，只能是手机号,正则为"+Constant.PHONE_REX,required = true)
    @NotNull(message = "请填写登录手机号")
    @Pattern(regexp = Constant.PHONE_REX,message = Constant.PHONE_REX_ERROR)
    private String loginName;

    @ApiModelProperty(value = "密码，正则为:"+Constant.PASSWORD_REX,required = true)
    @NotNull(message = "请填写密码")
    @Pattern(regexp = Constant.PASSWORD_REX,message = Constant.PASSWORD_REX_ERROR)
